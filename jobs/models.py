...
class Job(models.Model):
    ...
    create_date = models.DateTimeField(verbose_name='创建日期', default=datetime.datetime.now)
    modified_date = models.DateTimeField(verbose_name='修改时间', default=datetime.datetime.now)
...
class Resume(models.Model):
    ...
    created_date = models.DateTimeField(verbose_name="创建日期", default=datetime.datetime.now)
